...
| `.claude/workflow/bin/` | scripts déterministes : `n0.mjs` (build/typecheck/tests et preuve par session), `verifier-plan.mjs` (contrôles mécaniques) et `prochaine-action.mjs` (état d'une orchestration, lecture seule) |
