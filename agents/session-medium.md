---
name: session-medium
description: "Runs one plan session at effort medium. Launched only by /orchestrer-plan, which builds this name from the Effort column of the plan index. Never use proactively and never for delegation: this agent returns no conclusion to a parent, it IS the session."
effort: medium
---
