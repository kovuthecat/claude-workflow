...
## Les dix contrôles, dans cet ordre
...
- Aucune remarque sur le style, le découpage, le modèle choisi, l'effort, la formulation d'un
  objectif. Si tu n'as rien d'un des dix contrôles, tu n'as rien.
